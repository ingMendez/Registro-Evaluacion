<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cCategorias.aspx.cs" Inherits="RegistroEvaluaciones.UI.Consultas.cCategorias" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="card card-register mx-auto mt-5">
        <div class="card-header text-uppercase text-center">Consultar Categorias</div>
        <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row justify-content-center">
                        <asp:GridView ID="ConsultaGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                            ...
                            <Columns>
                                <asp:BoundField DataField="IdCategoria" HeaderText="PersonaId" />
