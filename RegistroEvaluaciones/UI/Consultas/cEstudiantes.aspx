<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cEstudiantes.aspx.cs" Inherits="RegistroEvaluaciones.UI.Consultas.cEstudiantes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="card card-register mx-auto mt-5">
        <div class="card-header text-uppercase text-center">Consultar Estudiante</div>
        <div class="card-body">
            <div class="form-row justify-content-center">
                ...
                <div class="form-group col-md-2">
                    ...
                    <asp:DropDownList ID="FiltroDropDownList" CssClass="form-control" runat="server">
                        ...
                        <asp:ListItem>Id Estudiante</asp:ListItem>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row justify-content-center">
                        <asp:GridView ID="ConsultaGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                            ...
                            <Columns>
                                <asp:BoundField DataField="IdEstudiante" HeaderText="PersonaId" />
                                <asp:BoundField DataField="NombreEstudiante" HeaderText="Nombre" />
